...
from .regression import wls_uncorrelated
from .sentence_evaluation import logical_evaluator
from .variable.common import Common, Fixed, generate_true_fixed_var
    ...
    def build_subcircuit(self, given_parent_node, contained_tree):
        ...
        while available_trees_to_be_explored.has_contents():
            ...
            #   https://en.wikipedia.org/wiki/Generalized_least_squares
                ...
                found_coef_vars = wls_uncorrelated(present_tree, available_parent_nodes)
                num_coef = len(found_coef_vars)

                # Adds the found coefficient variables to the parent nodes
                for a_parent_index in range(0, len(available_parent_nodes)):
                    ...
                    for a_coef_index in range(0, num_coef):
                        ...
                        a_coef_name = a_coef_var.variable_name
